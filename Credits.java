...
public class Credits extends JPanel {
    public Credits(ActionListener onClick) {
        ...
        // --- Center text ---
        JLabel label = new JLabel("<html>Created with the help of:<br/>"
                + "<br/>Robyn (maginn) <br/>Jane (pigeonflake)<br/>"
                + "Etta (milkyouroats)<br/>"
                + "James (verzifyy) <br/>Matthew (mattchoman)</html>",
